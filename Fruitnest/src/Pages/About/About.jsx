        ...
        <div>
            ...
            <section className="about">
                <div className="w-full my-4">
                    ...
                    <p className="text-black text-justify text-xl my-4">
            ...
            <section className="gallery">
                ...
                <div className="h-full w-full grid md:grid-cols-2 grid-cols-1 gap-10 justify-center overflow-hidden">
                    <div className="box bg-center bg-cover bg-no-repeat h-[50rem] overflow-hidden w-full hover:scale-105" style={{ backgroundImage: `url('SliderImages/black-bg.avif')` }}></div>
